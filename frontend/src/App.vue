...
import {ListDatabases, ListSuperTable, ListChildTable} from "../wailsjs/go/main/App.js";
...
<template>
  <div class="content">
    ...
    <div class="main">
      <div class="server-database-table">
        ...
        <div class="server-database-table-list">
          ...
          <div class="table-list" v-if="displayType === 3">
            <ChildTableList :child-table="item" v-for="item in childTableList" :key="item"></ChildTableList>
          </div>
        </div>
      ...
      <div class="data">
        121sssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssss
      </div>
    </div>
