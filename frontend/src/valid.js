 ...
 * 校验是否为空(null/空串)
 */
const checkNull = function (str) {
    return !(str == null || str === "");
};

const checkStrLen = function (str, len) {
 ...
 * 检验否是汉字
 */
const checkCharacter = function (charValue) {
    const reg = /^[\u4e00-\u9fa5]{0,}$/;
